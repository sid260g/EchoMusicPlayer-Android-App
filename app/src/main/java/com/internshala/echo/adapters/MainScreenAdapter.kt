...
class MainScreenAdapter(_songDetails: ArrayList<Songs>, _context: Context) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.trackTitle?.text=(songObject?.songTitle) //actual one trackTitle?.setText(songObject?.songTitle)
    ...
    class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            trackTitle = view.findViewById(R.id.trackTitle) as TextView //somr differences
